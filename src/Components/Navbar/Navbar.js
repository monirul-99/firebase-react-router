  ...
  return (
    <nav className="bg-[#111827] text-white">
      <header className="w-10/12 mx-auto flex justify-between items-center h-20 font-Poppins">
        ...
        <aside className="flex items-center lg:block hidden">
        ...
        <aside className="flex items-center">
          <MagnifyingGlassIcon class="h-6 w-6 text-white mx-5 lg:mx-0 md:mx-0" />
          <BellIcon class="h-6 w-6 text-white mx-5 hidden lg:block md:block" />
